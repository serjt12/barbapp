# Generated by Django 5.0.7 on 2024-08-15 22:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='shops.role')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='shops.service')),
            ],
        ),
        migrations.CreateModel(
            name='Appointment',
            fields=[
                ...
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appointments', to='shops.service')),
            ],
        ),
        migrations.CreateModel(
            name='Shop',
            fields=[
                ...
                ('opening_hours', models.CharField(max_length=60)),
        ...
        migrations.AddField(
            model_name='service',
            name='shop',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='services', to='shops.shop'),
        ),
        migrations.CreateModel(
            name='Employee',
            fields=[
                ...
                ('shop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employees', to='shops.shop')),
            ],
        ),
    ]
